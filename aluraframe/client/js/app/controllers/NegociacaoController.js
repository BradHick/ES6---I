    ...
    execute: function () {
      ...
      _export('NegociacaoController', NegociacaoController = function () {
        function NegociacaoController() {
          ...
          this._listaNegociacoes = new Bind(new ListaNegociacoes(), new NegociacoesView($('#negociacoesView')), 'adiciona', '_esvazia');

          this._mensagem = new Bind(new Mensagem(), //noca Mensagem
        ...
        _createClass(NegociacaoController, [{
          ...
          value: function apaga() {
            ...
            this._service.apaga().then(function (mensagem) {
              _this2._listaNegociacoes._esvazia();
